            ...
            <div class="row g-sm-4 g-3">
                                                                ...
                                                                <ul class="delivery-address-detail">
                                                                    ...
                                                                    <li>
                                                                        <h6 class="text-content mb-0"><span
                                                                                ...
                                                                                :</span> + 88{{auth()->user()->phonenumber}}</h6>
                                                                    </li>
                                                                </ul>
                                                            @endif        
                                                        </div>
                ...
                <div class="col-lg-4">
                    <div class="right-side-summery-box">
                        ...
                        <div class="summery-box-2 view-product">
                            <div class="summery-header">
                                <h3>Order Summery</h3>
                            </div>
                            @foreach($orderSummery as $orderSummeryView)
                                <ul class="summery-contain">
                                    <li>
                                        <img src="{{asset('Admin/images/'.$orderSummeryView->product->pimage)}}"
                                            class="img-fluid blur-up lazyloaded checkout-image" alt="">
                                        <h4>{{$orderSummeryView->product->pname}} <span>X {{$orderSummeryView->quantity}}</span></h4>
                                        <h4 class="price">{{$orderSummeryView->price}}</h4>
                                    </li>
                                </ul>
                            @endforeach
                            <ul class="summery-total">
                                ...
                                <li class="list-total">
                                    @php
                                        ...
                                        $shipping = 9.8;
                                        $tax = 10;
                                        $totalSummation = $subtotal + $shipping + $tax;
                                    @endphp
                                    <h4>Total (USD)</h4>
                                    <h4 class="price">{{$totalSummation}}</h4>
                                </li>
                            </ul>
