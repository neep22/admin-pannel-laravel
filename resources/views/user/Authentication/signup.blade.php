            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="log-in-box">
                        ...
                        <div class="input-box">
                            <form class="row g-4" action="{{route('add.userRegistration')}}" method="post">
                            @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-animation w-100 form_data">Sign Up</button>
                                </div>
                            </form>
                        </div>
                ...
                @include("user.Authentication.Js.signUpJs");
            </div>
        </div>
    </section>
    <!-- log in section end -->
