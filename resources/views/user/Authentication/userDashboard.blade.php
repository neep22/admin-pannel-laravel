...
@section("content")
    ...
    <section class="user-dashboard-section section-b-space">
                    ...
                    <div class="dashboard-left-sidebar">
                        ...
                        <div class="profile-box">
                            <div class="cover-image">
                                <img src="{{asset('user/images/user/cover-img.jpg')}}" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                            ...
                            <div class="profile-contain">
                                <div class="profile-image">
                                    <div class="position-relative">
                                        <img src="{{asset('user/images/user/'.$image)}}"
                        ...
                        <ul class="nav nav-pills user-nav-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-profile-update-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-profile-update" type="button" role="tab"
                                    aria-controls="pills-profile" aria-selected="false"><i data-feather="user"></i>
                ...
                <div class="col-xxl-9 col-lg-8">
                    ...
                    <div class="dashboard-right-sidebar">
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div id="pills-profile-update"
                                aria-labelledby="pills-profile-update-tab"
                                    ...
                                    <div class="col-12 mx-auto">
                                        <div class="log-in-box">
                                            ...
                                            <div class="input-box pt-3">
                                                <form class="row g-4" action="" method="post" enctype="multipart/form-data" id="userProfileUpdateForm">
                                                    @csrf
                                                    <input type="text" class="form-control" id="up_id" name="up_id" value="{{$id}}">
                                                    <div class="col-12">
                                                        <div class="">
                                                    ...
                                                    <div class="col-12">
                                                        <button type="submit" class="btn btn-animation w-100 form_data">Submit</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                    ...
                                    <div class="dashboard-bg-box">
                                        ...
                                        <div class="privacy-box">
                                            <div class="d-flex align-items-start">
                                                <h6>Allows others to see my profile-update</h6>
                                            ...
                                            <p class="text-content">all peoples will be able to see my profile-update</p>
                                        </div>

                                        <div class="privacy-box">
                                            <div class="d-flex align-items-start">
                                                <h6>who has save this profile-update only that people see my profile-update</h6>
                                                <div class="form-check form-switch switch-radio ms-auto">
                                                    <input class="form-check-input" type="checkbox" role="switch"
                                            ...
                                            <p class="text-content">all peoples will not be able to see my profile-update</p>
                                        </div>
        ...
        @include('user.Authentication.js.userProfileUpdateJs');
    </section>
