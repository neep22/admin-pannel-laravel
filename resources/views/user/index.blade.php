                                ...
                                <ul class="category-list">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="{{ asset ('Admin/images/category/'.$category->catimage) }}" alt="">
                                            ...
                                            <div class="list-2">
                                                ...
                                                <ul>
                                                    @foreach($category->subcategory as $subcategory)
                                                        <li>
                                                            <a href="javascript:void(0)">{{$subcategory->subcatname}}</a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                ...
                                @foreach($categories as $category)
                                    <li>r
                                        <div class="category-list">
                                            <img src="{{ asset ('Admin/images/category/'.$category->catimage) }}" class="blur-up lazyload" alt="">
                                            <h5>   
                                                    <a href="shop-left-sidebar.html">{{$category->catname}}</a>
                                                </h5>
                                        </div>
                                    </li>
                                @endforeach
                            ...
                            <div class="product-box-slider no-arrow">
                                ...
                                @foreach($products as    $product)
                                                ...
                                                <div class="product-box">
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="{{asset('Admin/images/'.$product->pimage)}}"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                        </a>
                                                    ...
                                                    <div class="product-detail">
                                                        <a href="product-left-thumbnail.html">
                                                            <h6 class="name">{{$product->pname}}</h6>
                                                        </a>
                                                        <a href="product-left-thumbnail.html">
                                                            <h6 class="name">{{$product->category->catname}}</h6>
                                                        </a>
                                                        <a href="product-left-thumbnail.html">
                                                        ...
                                                        <div class="product-rating mt-sm-2 mt-1">
                                                            ...
                                                            <h6 class="theme-color">{{$product->stock}}</h6>
                                                          `  
                                                        </div>
                                                        <div>
                                                        ...
                                                        <div class="add-to-cart-box">
                                                            ...
                                                            @foreach($order as $orderProductId)
                                                                 @if($orderProductId->product_id == $product->id)
                                                                    <span>match</span>
                                                                    @else
                                                                    <span>mismatch</span>
                                                                 @endif
                                                            @endforeach
                                                            <a class="btn btn-add-cart addcart-button orderId" id="status-container" type="submit" 
                                                                data-id="{{$product->id}}"
                                    ...
                                    <!-- Modal -->
                                     ...
                                     <!-- <div class="modal fade theme-modal view-modal show" id="viewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true" role="dialog">
