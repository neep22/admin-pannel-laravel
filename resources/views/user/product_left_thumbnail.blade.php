                                ...
                                <div class="note-box product-packege">
                                    <div class="cart_qty qty-box product-qty">
                                        <div class="input-group">
                                            <button type="button" class="qty-left-minus add_quantity" data-product_id="{{$getSingleData->id}}"
                                            data-price="{{$getSingleData->price}}"
                                                    data-field="">
                                                <i class="fa fa-minus" aria-hidden="true"></i>
                                            </button>
                                            <input class="form-control input-number qty-input"
                                                type="text" name="quantity" id="quantity" value="1">
                                            <button type="button" class="qty-right-plus add_quantity" data-product_id="{{$getSingleData->id}}"
                                            data-price="{{$getSingleData->price}}"
                                                    data-field="">
                                    ...
                                    <a href=""
                                        class=" btn-add-cart addcart-button orderId btn btn-md bg-dark cart-button text-white w-100"
                                        type="submit"
                                        data-id="{{$getSingleData->id}}"
                                        data-price="{{$getSingleData->price}}"
                                        >Add To Cart</a>
                                </div>
                                ...
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-2.html">
                                            <img src="{{asset('/Admin/images/'.$getCatProductData->pimage)}}"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
